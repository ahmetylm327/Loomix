...
> Örn: `https://loomix-xlp4.onrender.com/api/employee`
...
- **Listeleme (GET):** `/api/employee`
- **Ekleme (POST):** `/api/employee`
- **Güncelleme (PUT):** `/api/employee/:employeeId`
- **Silme (DELETE):** `/api//employee/:employeeId`
